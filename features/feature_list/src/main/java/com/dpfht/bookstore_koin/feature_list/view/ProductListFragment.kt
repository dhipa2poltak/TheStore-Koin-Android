...
import com.dpfht.bookstore_koin.feature_list.R
import com.dpfht.bookstore_koin.feature_list.adapter.ProductListAdapter
import com.dpfht.bookstore_koin.feature_list.databinding.FragmentProductListBinding
import com.dpfht.bookstore_koin.feature_list.databinding.FragmentProductListLandBinding
import com.dpfht.bookstore_koin.feature_list.di.ListModule
...
class ProductListFragment : Fragment(), KoinComponent {
  ...
  override fun onCreateView(
    ...
    isTablet = requireContext().resources.getBoolean(com.dpfht.bookstore_koin.framework.R.bool.isTablet)
    ...
    adapter.onClickProductListener = object : ProductListAdapter.OnClickProductListener {
      override fun onClickProduct(position: Int) {
        ...
        if (isTablet) {
          ...
          navHostFragment.navController.navigate(com.dpfht.bookstore_koin.feature_details.R.id.productDetailsFragment, bundle)
        } else {
